...
export const frFr: Translations = {
    ...
    settings: {
        ...
        down: "Bas",
        video: "Vidéo",
        networkPerformance: "Réseau / Performances",
        bitrate: "Débit (Kbps)",
        adaptiveBitrate: "Débit adaptatif (recommandé sur les réseaux chargés)",
        minimumBitrate: "Débit adaptatif minimum (Kbps)",
        fps: "Ips",
        ...
        videoFramePacing: "Cadencement des images (Canvas)",
        framePacingOff: "Désactivé (latence minimale)",
        framePacingBalanced: "Équilibré (absorbe jusqu'à 2 images de gigue)",
        framePacingSmooth: "Fluide (absorbe jusqu'à 4 images de gigue)",
        ...
        other: "Autre",
        securityPerformance: "Sécurité avancée / Performances",
        securityPerformanceWarning: "WebTransport reste toujours chiffré avec TLS. Ces options demandent seulement le chiffrement multimédia interne entre Sunshine/Apollo et le streamer ; sa prise en charge n'est pas garantie et l'hôte peut l'imposer. Les désactiver peut économiser un peu de processeur et de surcharge de paquets sur cette liaison, mais ne corrige pas la distance, les pertes ou la congestion côté client. Ne les désactivez que si cette liaison est fiable.",
        encryptHostVideo: "Demander le chiffrement vidéo de l'hôte (si disponible)",
        encryptHostAudio: "Demander le chiffrement audio de l'hôte (si disponible)",
        language: "Langue",
    ...
    admin: {
        ...
        delete: "Supprimer",
        apply: "Appliquer",
        userUpdated: "Paramètres utilisateur enregistrés.",
        userUpdateFailed: "Impossible d'enregistrer les paramètres utilisateur.",
        rolesLoadFailed: "Impossible de charger les rôles. Les paramètres utilisateur ne peuvent pas encore être enregistrés.",
        user: "Utilisateur",
        role: "Rôle",
        name: "Nom",
