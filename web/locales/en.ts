export const en = {
    ...
    settings: {
        ...
        adaptiveBitrate: "Adaptive Bitrate (recommended for busy networks)",
        minimumBitrate: "Minimum Adaptive Bitrate (Kbps)",
        fps: "Fps",
        ...
        videoFramePacing: "Canvas Frame Pacing",
        framePacingOff: "Off (lowest latency)",
        framePacingBalanced: "Balanced (absorbs up to 2 frames of jitter)",
        framePacingSmooth: "Smooth (absorbs up to 4 frames of jitter)",
        ...
        other: "Other",
        securityPerformance: "Advanced Security / Performance",
        securityPerformanceWarning: "WebTransport always remains TLS-encrypted. These options only request inner Sunshine/Apollo-to-streamer media encryption; support is not guaranteed, and the host may force it. Turning them off may save a little CPU and packet overhead on that hop, but it does not fix client-side distance, loss, or congestion. Opt out only when that hop is trusted.",
        encryptHostVideo: "Request Host Video Encryption (best effort)",
        encryptHostAudio: "Request Host Audio Encryption (best effort)",
        language: "Language",
    ...
    admin: {
        ...
        delete: "Delete",
        apply: "Apply",
        userUpdated: "User settings saved.",
        userUpdateFailed: "Couldn't save user settings.",
        rolesLoadFailed: "Couldn't load roles. User settings cannot be saved yet.",
        user: "User",
        role: "Role",
        name: "Name",
